...
> 141 项测试全绿。**唯一没做的是 reasoning 降档巡检**——下面标 🚧 的就是它。
...
node scripts/verify-relay.js --endpoint <id>   # ✅ L2 校准比对（180 次）——L1 报警才上
...
```bash
node scripts/refresh-reference.js --endpoint <正版 id> --model <m> --cells all
```
